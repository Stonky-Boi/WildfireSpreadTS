...
class BaseModel(pl.LightningModule, ABC):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        Args:
            n_channels (int): _description_ Number of feature channels in the input data.
            flatten_temporal_dimension (bool): _description_ Whether to flatten the temporal dimension.
            pos_class_weight (float): _description_ Weight of the positive class.
            loss_function (Literal): _description_ Which loss function to use. 
            use_doy (bool, optional): _description_. Whether to use doy. Defaults to False.
            required_img_size (Optional[List[int]], optional): _description_. Defaults to None. 
        """
    ...
    def get_pred_and_gt(self, batch):
        ...
        Raises:
            ValueError: _description_ If the batch size is not 1 and the model requires repeated inference.
